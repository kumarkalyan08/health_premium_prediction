...
model_young = joblib.load('premium_model_files/model_young.joblib')
model_rest = joblib.load("premium_model_files/model_rest.joblib")
scaler_young = joblib.load("premium_model_files/scaler_young.joblib")
scaler_rest = joblib.load("premium_model_files/scaler_rest.joblib")
